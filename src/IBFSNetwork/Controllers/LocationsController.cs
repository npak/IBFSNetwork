...
namespace IBFSNetwork.Controllers
{
    ...
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LocationId,Caption")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocationId,Caption")] Location location)
        {
