...
namespace IBFSNetwork.Migrations
{
    ...
    [Migration("20160914105136_UpdateFraudsterModel3")]
    partial class UpdateFraudsterModel3
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("IBFSNetwork.Models.AlertViewModels.AlertFraudster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("IBFSNetwork.Models.Questionnaire", b =>
                {
            ...
            modelBuilder.Entity("IBFSNetwork.Models.QuestionnaireAnswer", b =>
                {
            ...
            modelBuilder.Entity("IBFSNetwork.Models.QuestionnaireModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("IBFSNetwork.Models.AlertViewModels.AlertFraudster", b =>
                {
                    b.HasOne("IBFSNetwork.Models.AlertViewModels.Alert", "Alert")
                        .WithOne("AlertFraudster")
                        .HasForeignKey("IBFSNetwork.Models.AlertViewModels.AlertFraudster", "AlertId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("IBFSNetwork.Models.AlertViewModels.Fraudster", "Fraudster")
                        .WithMany()
            ...
            modelBuilder.Entity("IBFSNetwork.Models.AlertViewModels.Fraudster", b =>
                {
                    b.HasOne("IBFSNetwork.Models.AlertViewModels.Alert")
                        .WithMany("Fraudsters")
            ...
            modelBuilder.Entity("IBFSNetwork.Models.QuestionnaireAnswer", b =>
                {
                    b.HasOne("IBFSNetwork.Models.QuestionnaireModel")
