...
namespace IBFSNetwork.Migrations
{
    ...
    [Migration("20160801114758_AddForumTablesBack")]
    partial class AddForumTablesBack
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("IBFSNetwork.Models.ForumViewModels.MainThread", b =>
                {
                    ...
                    b.HasKey("MainThreadId");

                    b.ToTable("MainThread");
                });
            ...
            modelBuilder.Entity("IBFSNetwork.Models.ForumViewModels.Replay", b =>
                {
            ...
            modelBuilder.Entity("IBFSNetwork.Models.ForumViewModels.SubThread", b =>
                {
                    b.HasOne("IBFSNetwork.Models.ForumViewModels.MainThread", "MainThread")
                        .WithMany()
